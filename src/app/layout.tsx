  ...
  return (
    <html lang="ko">
      ...
      <body className={inter.className}>
        {children}
        {/* Google AdSense Script - Moved outside head to avoid data-nscript warning */}
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7379075324068520"
