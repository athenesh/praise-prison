...
export const metadata: Metadata = {
  ...
  keywords: ["멘탈 케어", "칭찬", "자존감 향상", "긍정 에너지", "AI 칭찬", "우울 해소", "스트레스 해소", "무료 힐링", "유머 치료", "긍정 교화소", "정신 건강", "셀프케어"],
  ...
  verification: {
    google: "google-site-verification-code", // You can add this later after Google Search Console verification
  },
};
=======
export const metadata: Metadata = {
